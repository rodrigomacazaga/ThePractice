        ...
        <section id="calculadora" className="scroll-mt-20 py-20">
          <div className="container-page">
            <SectionHeading
              ...
              description="Aquí entran los créditos, la mecánica interna de las membresías: tu plan te da una bolsa mensual que usas donde quieras. Una hora estándar cuesta 1 crédito; premium, 1.5; studio, 2. Usas cualquier sala sin cambiar de plan."
              align="center"
            />
